...
//All rights reserved	
//********************************************************************************
//V1.1ĞŞ¸ÄËµÃ÷ 20150528
//ĞŞÕıÁËCAN³õÊ¼»¯º¯ÊıµÄÏà¹Ø×¢ÊÍ£¬¸üÕıÁË²¨ÌØÂÊ¼ÆËã¹«Ê½
////////////////////////////////////////////////////////////////////////////////// 	 
...
//Fpclk1µÄÊ±Ö ÓÔÚ³õÊ¼»¯µÄÊ±ºòÉèÖÃÎª36M,Èç¹ûÉèÖÃCAN_Mode_Init(CAN_SJW_1tq,CAN_BS2_8tq,CAN_BS1_9tq,4,CAN_Mode_LoopBack);
...
u8 Can_Send_Msg2(u8* msg,u8 len)
{	
	u8 mbox;
	u16 i=0;
	CanTxMsg TxMessage;
	TxMessage.StdId=0x01ff;			// ±ê×¼±êÊ¶·û 
	TxMessage.ExtId=0x12;			// ÉèÖÃÀ©Õ¹±êÊ¾·û 
	TxMessage.IDE=CAN_Id_Standard; 	// ±ê×¼Ö¡
	TxMessage.RTR=CAN_RTR_Data;		// Êı¾İÖ¡
	TxMessage.DLC=len;				// Òª·¢ËÍµÄÊı¾İ³¤¶È
...
//		buf[0]=RxMessage.StdId>>8;
//	  buf[1]=RxMessage.StdId;
//    for(i=2;i<10;i++)
